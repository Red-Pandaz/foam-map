                ...
                .then(blob => {
                    ...
                    image.onload = () => {
                        ...
                        if (coordinates) {
                            ...
                            // Create the pannable container div
                            const popupContainer = document.createElement('div');
                            popupContainer.classList.add('popup-container'); // Add a class for styling
                            ...
                            geoJsonFeatures.forEach(feature => {
                                ...
                                if (lng === coordinates.lng && lat === coordinates.lat) {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        const selectButton = selectTx.previousElementSibling;
                                        if (selectTx) {
                                          
                                            selectTx.style.display = 'block';
                                            selectTx.scrollIntoView({ behavior: 'smooth', block: 'center' });   
                                            selectButton.classList.toggle('active', true)                            
                                        } else {
